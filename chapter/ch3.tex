...
\item \mathbf{StartX}：此区间x轴上最小值
\item \mathbf{StartY}：此区间x轴上最小值对应的y值
\item \mathbf{StartX}：此区间x轴上最大值
\item \mathbf{StartX}：此区间x轴上最大值对应的y值
\item \mathbf{Parament}：此区间轨迹拟合函数参数
\end{itemize}
...
\hline
\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}beta\\ \\ 评价指标\end{tabular}} & \multicolumn{2}{c|}{0.1}     & \multicolumn{2}{c|}{0.3}     & \multicolumn{2}{c|}{0.5}     \\ \cline{2-7} 
...
\begin{figure}[h]
	\includegraphics{differentALPHA.png}
