...
\subsection{实验与分析}
实验是在真实的数据集上进行的，这些数据集包含了在大阪的ATC购物中心的游客的轨迹。在我们的实验中，我们应用了位置x、位置y、人物id字段\footnote[1]{https://irc.atr.jp/crest2010_HRI/ATC_dataset/}。经过预处理后，我们选择了549条轨迹作为原始数据集，每条轨迹包含500个点。
...
\subfigure[]{
\label{gen5}
\includegraphics[width=0.4\textwidth]{point_sample_5.png}}
\subfigure[]{
\label{origin}
...
\subfigure[]{
\label{gen01}
\includegraphics[width=0.4\textwidth]{tr_sample_01.png}}
\subfigure[]{
\label{gen05}
\includegraphics[width=0.4\textwidth]{tr_sample_05.png}}
\subfigure[]{
\label{gen09}
\includegraphics[width=0.4\textwidth]{tr_sample_09.png}}
\subfigure[]{
\label{origin}
\includegraphics[width=0.4\textwidth]{ch3original.png}}
