...
\item \textbf{StartY}：此区间x轴上最小值对应的y值
\item \textbf{StartX}：此区间x轴上最大值
\item \textbf{StartX}：此区间x轴上最大值对应的y值
...
\begin{figure}[h]
	\includegraphics[height=4.5cm,width=7.5cm]{differentALPHA.png}
